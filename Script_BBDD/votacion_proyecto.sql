...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2023 a las 13:56:11
...
--
-- Base de datos: `votacion_proyecto`
--
...
INSERT INTO `comunas` (`id_comuna`, `comuna`, `region_id`) VALUES
(1, 'Arica', 1),
(2, 'Camarones', 1),
(3, 'General Lagos', 1),
(4, 'Putre', 1),
...
CREATE TABLE `medios_comunicacion` (
  ...
  `tv` varchar(150) NOT NULL,
  `red_social` varchar(150) NOT NULL,
...
INSERT INTO `regiones` (`id_region`, `region`, `abreviatura`, `capital`) VALUES
